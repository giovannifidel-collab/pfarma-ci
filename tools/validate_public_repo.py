...
ALLOWED_EXACT = {
    ...
    PurePosixPath("razzo/PRODUCT_COMPLETION_POLICY.md"),
    PurePosixPath("razzo/product-completion-policy.json"),
    PurePosixPath("razzo/macrocycle-policy.json"),
    PurePosixPath("razzo/macrocycles.json"),
