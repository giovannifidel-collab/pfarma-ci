...
ALLOWED_EXACT = {
    ...
    PurePosixPath(".github/workflows/homo-novus-phase4-certify.yml"),
    ...
    PurePosixPath("razzo/super_factory/phase4_certifier.py"),
    PurePosixPath("razzo/super_factory/test_phase4_certifier.py"),
