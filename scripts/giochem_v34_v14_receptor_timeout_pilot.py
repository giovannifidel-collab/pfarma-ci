...
EXECUTION_MODE = 'V14_RECEPTOR_SPLIT_PER_DOCKING_TIMEOUT_ONLY_TECHNICAL_PILOT'
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix=f'giochem-v34-v14-{args.target}-r{args.receptor_index}-') as td:
