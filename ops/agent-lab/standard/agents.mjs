...
export const AGENT_CONFIGS = [
  {id:'kimi',product:'Kimi Web / Kimi Code',port:9223,scanPorts:[9223],startScript:'kimi/start-browser.sh',homeUrl:'https://www.kimi.ai/',targetPattern:/kimi\.(com|ai)|moonshot/i,composerPatterns:['ask.*kimi','message.*kimi','chat with kimi','send a message','^message$'],submitPatterns:['^send$','send message','submit'],inputMode:'keyboard',blockPatterns:['log in to kimi','sign in to kimi','continue with.*(google|apple|phone)'],freshChat:true},
  {id:'claude',product:'Claude Web',port:9224,startScript:'claude/start-browser.sh',homeUrl:'https://claude.ai/',targetPattern:/claude\.ai/i,composerPatterns:['message claude','ask claude','send a message','^message$'],submitPatterns:['send message','^send$'],inputMode:'keyboard',blockPatterns:['log in to claude','sign in to claude'],freshChat:true},
